...
public class CountingTimerView extends View {
    ...
    public CountingTimerView(Context context, AttributeSet attrs) {
        ...
        mWhiteColor = r.getColor(com.betterAlarm.deskclock.R.color.clock_white);
        mDefaultColor = mWhiteColor;
        mPressedColor = r.getColor(com.betterAlarm.deskclock.R.color.hot_pink);
        mAccentColor = r.getColor(com.betterAlarm.deskclock.R.color.hot_pink);
        mBigFontSize = r.getDimension(com.betterAlarm.deskclock.R.dimen.big_font_size);
        mSmallFontSize = r.getDimension(com.betterAlarm.deskclock.R.dimen.small_font_size);
    ...
    private static String getTimeStringForAccessibility(int hours, int minutes, int seconds,
        ...
        if (showNeg && hours == 0 && minutes == 0) {
            ...
            s.append(String.format(
                    r.getQuantityText(com.betterAlarm.deskclock.R.plurals.Nseconds_description, seconds).toString(),
                    seconds));
        } else if (hours == 0) {
            s.append(String.format(
                    r.getQuantityText(com.betterAlarm.deskclock.R.plurals.Nminutes_description, minutes).toString(),
                    minutes));
            s.append(" ");
            s.append(String.format(
                    r.getQuantityText(com.betterAlarm.deskclock.R.plurals.Nseconds_description, seconds).toString(),
            ...
            s.append(String.format(
                    r.getQuantityText(com.betterAlarm.deskclock.R.plurals.Nhours_description, hours).toString(),
                    hours));
            s.append(" ");
            s.append(String.format(
                    r.getQuantityText(com.betterAlarm.deskclock.R.plurals.Nminutes_description, minutes).toString(),
