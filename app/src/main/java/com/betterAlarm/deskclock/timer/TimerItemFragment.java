...
public class TimerItemFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        final FrameLayout labelLayout = (FrameLayout) v.findViewById(com.betterAlarm.deskclock.R.id.timer_label);
        final TextView labelPlaceholder = (TextView) v.findViewById(com.betterAlarm.deskclock.R.id.timer_label_placeholder);
        final TextView labelText = (TextView) v.findViewById(com.betterAlarm.deskclock.R.id.timer_label_text);
