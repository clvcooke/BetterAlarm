...
public class TimerView extends LinearLayout {
    ...
    public TimerView(Context context, AttributeSet attrs) {
        ...
        mWhiteColor = resources.getColor(com.betterAlarm.deskclock.R.color.clock_white);
        mGrayColor = resources.getColor(com.betterAlarm.deskclock.R.color.clock_gray);
    }
    ...
    protected void onFinishInflate() {
        ...
        mHoursOnes = (TextView) findViewById(com.betterAlarm.deskclock.R.id.hours_ones);
        if (mHoursOnes != null) {
            mOriginalHoursTypeface = mHoursOnes.getTypeface();
        }
        mMinutesTens = (TextView) findViewById(com.betterAlarm.deskclock.R.id.minutes_tens);
        if (mHoursOnes != null && mMinutesTens != null) {
            addStartPadding(mMinutesTens);
        }
        mMinutesOnes = (TextView) findViewById(com.betterAlarm.deskclock.R.id.minutes_ones);
        if (mMinutesOnes != null) {
            mOriginalMinutesTypeface = mMinutesOnes.getTypeface();
        }
        mSeconds = (TextView) findViewById(com.betterAlarm.deskclock.R.id.seconds);
        if (mSeconds != null) {
