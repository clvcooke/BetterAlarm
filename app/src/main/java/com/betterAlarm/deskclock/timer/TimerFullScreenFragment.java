...
package com.betterAlarm.deskclock.timer;
...
import com.betterAlarm.deskclock.LabelDialogFragment;
import com.betterAlarm.deskclock.LogUtils;
import com.betterAlarm.deskclock.TimerSetupView;
import com.betterAlarm.deskclock.Utils;
import com.betterAlarm.deskclock.widget.sgv.GridAdapter;
import com.betterAlarm.deskclock.widget.sgv.SgvAnimationHelper.AnimationIn;
import com.betterAlarm.deskclock.widget.sgv.SgvAnimationHelper.AnimationOut;
import com.betterAlarm.deskclock.widget.sgv.StaggeredGridView;
...
public class TimerFullScreenFragment extends DeskClockFragment
    ...
    private class TimersListAdapter extends GridAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            final TimerListItem v = (TimerListItem) inflater.inflate(com.betterAlarm.deskclock.R.layout.timer_list_item,
                    null);
            ...
            final CountingTimerView countingTimerView = (CountingTimerView)
                    v.findViewById(com.betterAlarm.deskclock.R.id.timer_time_text);
            ...
            CircleButtonsLayout circleLayout =
                    (CircleButtonsLayout) v.findViewById(com.betterAlarm.deskclock.R.id.timer_circle);
            circleLayout.setCircleTimerViewIds(com.betterAlarm.deskclock.R.id.timer_time, com.betterAlarm.deskclock.R.id.reset_add, com.betterAlarm.deskclock.R.id.timer_label,
                    com.betterAlarm.deskclock.R.id.timer_label_text);

            ImageButton resetAddButton = (ImageButton) v.findViewById(com.betterAlarm.deskclock.R.id.reset_add);
            resetAddButton.setTag(new ClickAction(ClickAction.ACTION_PLUS_ONE, o));
            v.setResetAddButton(true, TimerFullScreenFragment.this);
            FrameLayout label = (FrameLayout) v.findViewById(com.betterAlarm.deskclock.R.id.timer_label);
            TextView labelIcon = (TextView) v.findViewById(com.betterAlarm.deskclock.R.id.timer_label_placeholder);
            TextView labelText = (TextView) v.findViewById(com.betterAlarm.deskclock.R.id.timer_label_text);
            if (o.mLabel.equals("")) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(com.betterAlarm.deskclock.R.layout.timer_full_screen_fragment, container, false);
        ...
        mFab = (ImageButton) v.findViewById(com.betterAlarm.deskclock.R.id.fab);
        mTimersList = (StaggeredGridView) v.findViewById(com.betterAlarm.deskclock.R.id.timers_list);
        // For tablets in landscape, the count will be 2. All else will be 1.
        mColumnCount = getResources().getInteger(com.betterAlarm.deskclock.R.integer.timer_column_count);
        ...
        mTimersListPage = v.findViewById(com.betterAlarm.deskclock.R.id.timers_list_page);
        mTimerSetup = (TimerSetupView) v.findViewById(com.betterAlarm.deskclock.R.id.timer_setup);
    ...
    public void onResume() {
        ...
        LayoutParams params;
        float dividerHeight = getResources().getDimension(com.betterAlarm.deskclock.R.dimen.timer_divider_height);
        if (getActivity() instanceof DeskClock) {
            ...
            View footerView = getActivity().getLayoutInflater().inflate(
                    com.betterAlarm.deskclock.R.layout.blank_footer_view, mTimersList, false);
        ...
        mFab.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                revealAnimation(mFab, getActivity().getResources().getColor(com.betterAlarm.deskclock.R.color.clock_white));
    ...
    private void gotoSetupView() {
        if (mLastVisibleView == null || mLastVisibleView.getId() == com.betterAlarm.deskclock.R.id.timer_setup) {
    ...
    private void gotoTimersView() {
        if (mLastVisibleView == null || mLastVisibleView.getId() == com.betterAlarm.deskclock.R.id.timers_list_page) {
