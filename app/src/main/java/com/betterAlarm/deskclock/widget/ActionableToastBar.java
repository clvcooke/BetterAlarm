...
package com.betterAlarm.deskclock.widget;
...
public class ActionableToastBar extends LinearLayout {
    ...
    public ActionableToastBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        mBottomMarginSizeInConversation = context.getResources().getDimensionPixelSize(
                com.betterAlarm.deskclock.R.dimen.toast_bar_bottom_margin_in_conversation);
        LayoutInflater.from(context).inflate(com.betterAlarm.deskclock.R.layout.actionable_toast_row, this, true);
    }
    ...
    protected void onFinishInflate() {
        ...
        mActionDescriptionIcon = (ImageView) findViewById(com.betterAlarm.deskclock.R.id.description_icon);
        mActionDescriptionView = (TextView) findViewById(com.betterAlarm.deskclock.R.id.description_text);
        mActionButton = findViewById(com.betterAlarm.deskclock.R.id.action_button);
        mActionIcon = findViewById(com.betterAlarm.deskclock.R.id.action_icon);
        mActionText = (TextView) findViewById(com.betterAlarm.deskclock.R.id.action_text);
    }
    ...
    private Animator getShowAnimation() {
        if (mShowAnimation == null) {
            mShowAnimation = AnimatorInflater.loadAnimator(getContext(), com.betterAlarm.deskclock.R.animator.fade_in);
    ...
    private Animator getHideAnimation() {
        if (mHideAnimation == null) {
            mHideAnimation = AnimatorInflater.loadAnimator(getContext(), com.betterAlarm.deskclock.R.animator.fade_out);
