...
import com.betterAlarm.deskclock.AnalogClock;
...
public class WorldClockAdapter extends BaseAdapter {
    ...
    public WorldClockAdapter(Context context) {
        ...
        mClocksPerRow = context.getResources().getInteger(com.betterAlarm.deskclock.R.integer.world_clocks_per_row);
    }
    ...
    public void loadData(Context context) {
        ...
        mClockStyle = prefs.getString(SettingsActivity.KEY_CLOCK_STYLE,
                mContext.getResources().getString(com.betterAlarm.deskclock.R.string.default_clock_style));
    ...
    private Object[] addHomeCity() {
        if (needHomeCity()) {
            ...
            CityObj c = new CityObj(
                    mContext.getResources().getString(com.betterAlarm.deskclock.R.string.home_label), homeTZ, null);
    ...
    public void updateHomeLabel(Context context) {
        ...
        if (needHomeCity() && mCitiesList.length > 0) {
            ((CityObj) mCitiesList[0]).mCityName =
                    context.getResources().getString(com.betterAlarm.deskclock.R.string.home_label);
        }
    }
    ...
    public View getView(int position, View view, ViewGroup parent) {
        ...
        if (view == null) {
            view = mInflater.inflate(com.betterAlarm.deskclock.R.layout.world_clock_list_item, parent, false);
        }
        updateView(view.findViewById(com.betterAlarm.deskclock.R.id.city_left), (CityObj)mCitiesList[index]);
        return view;
    }

    private void updateView(View clock, CityObj cityObj) {
        View nameLayout= clock.findViewById(com.betterAlarm.deskclock.R.id.city_name_layout);
        TextView name = (TextView)(nameLayout.findViewById(com.betterAlarm.deskclock.R.id.city_name));
        TextView dayOfWeek = (TextView)(nameLayout.findViewById(com.betterAlarm.deskclock.R.id.city_day));
        TextClock dclock = (TextClock)(clock.findViewById(com.betterAlarm.deskclock.R.id.digital_clock));
        AnalogClock aclock = (AnalogClock)(clock.findViewById(com.betterAlarm.deskclock.R.id.analog_clock));
        ...
        if (mClockStyle.equals("analog")) {
            ...
            Utils.setTimeFormat(dclock,
                    (int)mContext.getResources().getDimension(com.betterAlarm.deskclock.R.dimen.label_font_size));
        }
        ...
        if (myDayOfWeek != cityDayOfWeek) {
            dayOfWeek.setText(mContext.getString(com.betterAlarm.deskclock.R.string.world_day_of_week_label,
