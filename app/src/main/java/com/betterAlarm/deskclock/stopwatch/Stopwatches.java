...
public class Stopwatches {
    ...
    public static String getShareTitle(Context context) {
        String [] mLabels = context.getResources().getStringArray(com.betterAlarm.deskclock.R.array.sw_share_strings);
    ...
    public static String buildShareResults(Context context, String time, long[] laps) {
        StringBuilder b = new StringBuilder (context.getString(com.betterAlarm.deskclock.R.string.sw_share_main, time));
        b.append("\n");
        ...
        b.append(context.getString(com.betterAlarm.deskclock.R.string.sw_share_laps));
        b.append("\n");
    ...
    public static String getTimeText(Context context, long time, int lap) {
        ...
        if (lap != NO_LAP_NUMBER) {
            formats = context.getResources().getStringArray(com.betterAlarm.deskclock.R.array.shared_laps_format_set);
        } else {
            formats = context.getResources().getStringArray(com.betterAlarm.deskclock.R.array.stopwatch_format_set);
        }
