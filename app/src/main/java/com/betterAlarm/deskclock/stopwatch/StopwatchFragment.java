package com.betterAlarm.deskclock.stopwatch;
...
import com.betterAlarm.deskclock.CircleButtonsLayout;
import com.betterAlarm.deskclock.CircleTimerView;
import com.betterAlarm.deskclock.DeskClock;
import com.betterAlarm.deskclock.DeskClockFragment;
import com.betterAlarm.deskclock.LogUtils;
import com.betterAlarm.deskclock.Utils;
import com.betterAlarm.deskclock.timer.CountingTimerView;
...
public class StopwatchFragment extends DeskClockFragment
    ...
    class LapsListAdapter extends BaseAdapter {
        ...
        public LapsListAdapter(Context context) {
            ...
            mFormats = context.getResources().getStringArray(com.betterAlarm.deskclock.R.array.stopwatch_format_set);
            mLapFormatSet = context.getResources().getStringArray(com.betterAlarm.deskclock.R.array.sw_lap_number_set);
            updateLapFormat();
        }
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (getItemViewType(position) == VIEW_TYPE_SPACE) {
                return convertView != null ? convertView
                        : mInflater.inflate(com.betterAlarm.deskclock.R.layout.stopwatch_spacer, parent, false);
            }

            final View lapInfo = convertView != null ? convertView
                    : mInflater.inflate(com.betterAlarm.deskclock.R.layout.lap_view, parent, false);
            Lap lap = getItem(position);
            lapInfo.setTag(lap);

            TextView count = (TextView) lapInfo.findViewById(com.betterAlarm.deskclock.R.id.lap_number);
        ...
        protected void setTimeText(View lapInfo, Lap lap) {
            TextView lapTime = (TextView)lapInfo.findViewById(com.betterAlarm.deskclock.R.id.lap_time);
            TextView totalTime = (TextView)lapInfo.findViewById(com.betterAlarm.deskclock.R.id.lap_total);
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        ViewGroup v = (ViewGroup)inflater.inflate(com.betterAlarm.deskclock.R.layout.stopwatch_fragment, container, false);

        mTime = (CircleTimerView)v.findViewById(com.betterAlarm.deskclock.R.id.stopwatch_time);
        mTimeText = (CountingTimerView)v.findViewById(com.betterAlarm.deskclock.R.id.stopwatch_time_text);
        mLapsList = (ListView)v.findViewById(com.betterAlarm.deskclock.R.id.laps_list);
        ...
        mCircleLayout = (CircleButtonsLayout)v.findViewById(com.betterAlarm.deskclock.R.id.stopwatch_circle);
        mCircleLayout.setCircleTimerViewIds(com.betterAlarm.deskclock.R.id.stopwatch_time, 0 /* stopwatchId */ ,
        ...
        mStartSpace = v.findViewById(com.betterAlarm.deskclock.R.id.start_space);
        mEndSpace = v.findViewById(com.betterAlarm.deskclock.R.id.end_space);
        mSpacersUsed = mStartSpace != null || mEndSpace != null;

        // Only applicable on portrait, only visible when there is no lap
        mBottomSpace = v.findViewById(com.betterAlarm.deskclock.R.id.bottom_space);
    ...
    private void shareResults() {
        ...
        final Intent launchIntent = Intent.createChooser(shareIntent,
                context.getString(com.betterAlarm.deskclock.R.string.sw_share_button));
        try {
    ...
    public void setFabAppearance() {
        ...
        if (mState == Stopwatches.STOPWATCH_RUNNING) {
            mFab.setImageResource(com.betterAlarm.deskclock.R.drawable.ic_fab_pause);
            mFab.setContentDescription(getString(com.betterAlarm.deskclock.R.string.sw_stop_button));
        } else {
            mFab.setImageResource(com.betterAlarm.deskclock.R.drawable.ic_fab_play);
            mFab.setContentDescription(getString(com.betterAlarm.deskclock.R.string.sw_start_button));
        }
    ...
    public void setLeftRightButtonAppearance() {
        ...
        mRightButton.setImageResource(com.betterAlarm.deskclock.R.drawable.ic_share);
        mRightButton.setContentDescription(getString(com.betterAlarm.deskclock.R.string.sw_share_button));

        switch (mState) {
            case Stopwatches.STOPWATCH_RESET:
                mLeftButton.setImageResource(com.betterAlarm.deskclock.R.drawable.ic_lap);
                mLeftButton.setContentDescription(getString(com.betterAlarm.deskclock.R.string.sw_lap_button));
            ...
            case Stopwatches.STOPWATCH_RUNNING:
                ...
                break;
            case Stopwatches.STOPWATCH_STOPPED:
                mLeftButton.setImageResource(com.betterAlarm.deskclock.R.drawable.ic_reset);
                mLeftButton.setContentDescription(getString(com.betterAlarm.deskclock.R.string.sw_reset_button));
