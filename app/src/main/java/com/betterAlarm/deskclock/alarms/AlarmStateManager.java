...
import com.betterAlarm.deskclock.AlarmAlertWakeLock;
import com.betterAlarm.deskclock.AlarmClockFragment;
import com.betterAlarm.deskclock.AlarmUtils;
import com.betterAlarm.deskclock.AsyncHandler;
    ...
    public static void setSnoozeState(Context context, AlarmInstance instance, boolean showToast) {
        ...
        if (showToast) {
            String displayTime = String.format(context.getResources().getQuantityText
                    (com.betterAlarm.deskclock.R.plurals.alarm_alert_snooze_set, snoozeMinutes).toString(), snoozeMinutes);
