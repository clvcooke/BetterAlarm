...
import com.betterAlarm.deskclock.AlarmClockFragment;
import com.betterAlarm.deskclock.AlarmUtils;
import com.betterAlarm.deskclock.DeskClock;
import com.betterAlarm.deskclock.LogUtils;
import com.betterAlarm.deskclock.provider.Alarm;
...
public final class AlarmNotifications {
    ...
    public static void showLowPriorityNotification(Context context, AlarmInstance instance) {
        ...
        Notification.Builder notification = new Notification.Builder(context)
                .setContentTitle(resources.getString(com.betterAlarm.deskclock.R.string.alarm_alert_predismiss_title))
                .setContentText(AlarmUtils.getAlarmText(context, instance))
                .setSmallIcon(com.betterAlarm.deskclock.R.drawable.stat_notify_alarm)
                .setOngoing(false)
                .setAutoCancel(false)
        ...
        notification.addAction(com.betterAlarm.deskclock.R.drawable.ic_alarm_off_black,
                resources.getString(com.betterAlarm.deskclock.R.string.alarm_alert_dismiss_now_text),
    ...
    public static void showSnoozeNotification(Context context, AlarmInstance instance) {
        ...
        Notification.Builder notification = new Notification.Builder(context)
                ...
                .setContentText(resources.getString(com.betterAlarm.deskclock.R.string.alarm_alert_snooze_until,
        ...
        Intent dismissIntent = AlarmStateManager.createStateChangeIntent(context,
                AlarmStateManager.ALARM_DISMISS_TAG, instance, AlarmInstance.DISMISSED_STATE);
        notification.addAction(com.betterAlarm.deskclock.R.drawable.ic_alarm_off_black,
                resources.getString(com.betterAlarm.deskclock.R.string.alarm_alert_dismiss_text),
                PendingIntent.getBroadcast(context, instance.hashCode(),
                        dismissIntent, PendingIntent.FLAG_UPDATE_CURRENT));
    ...
    public static void showMissedNotification(Context context, AlarmInstance instance) {
        ...
        String contextText = instance.mLabel.isEmpty() ? alarmTime :
                context.getString(com.betterAlarm.deskclock.R.string.alarm_missed_text, alarmTime, label);
        Notification.Builder notification = new Notification.Builder(context)
                .setContentTitle(context.getString(com.betterAlarm.deskclock.R.string.alarm_missed_title))
    ...
    public static void showAlarmNotification(Context context, AlarmInstance instance) {
        ...
        notification.addAction(com.betterAlarm.deskclock.R.drawable.ic_snooze_black,
                resources.getString(com.betterAlarm.deskclock.R.string.alarm_alert_snooze_text), snoozePendingIntent);
